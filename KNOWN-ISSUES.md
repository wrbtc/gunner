...
v0.54.70 is a Field Guide-first identity. Rimmers, plasma bugs, Ember Hollow
...
`cinder_weight_shift` remain selectable. Dancing Creepers VIEW 3D plays
...
as one uniform opaque leather membrane with a sealed root tuft. A thin occupancy
shadow lets the maggot read as a silhouette under the leather, not through a
glass window. The Shell specimen stays shell-only. Live nests,
...
- `field-notes-v02/cinder-maw-fieldnotes-v02.glb` — 1483396 bytes, `2a829abf…` (repaired TankArmature; three presentation clips)
- `vein-ascetic-skinned.glb` — 1908316 bytes, `9d67a8c5…` (VeinArmature; ritual_idle / ritual_walk). Reject draft `3b3dc30a…` / `vein-ascetic-skinned-draft.glb` / 2502928.
- `egg-shell-a.glb` — 817236 bytes, `368d9e85…`
- `field-notes-v02/egg-maggot-fieldnotes-v02.glb` — 1075680 bytes, `344d2131…` (MaggotArmature; maggot_wriggle)

This tip includes the real LFS objects on those paths. Cinder and larva retain
...
0.54.52, 0.54.53, 0.54.56, 0.54.57, 0.54.58, 0.54.59, 0.54.60, 0.54.61, 0.54.62, 0.54.63, 0.54.64, 0.54.65, 0.54.66, 0.54.67, 0.54.68 or 0.54.69 as this identity.
...
Confirm VIEW 3D for rimmers, plasma, creepers, tanks, dancers, dragons, and
eggs. The Queen stays ENLARGE.
