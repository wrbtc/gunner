...
assert.match(html,/mobile-entry\.js\?v=desktop-054-23/);
assert.match(html,/data-game-entry="\.\/main\.js\?v=054-23"/);
...
assert.match(read('mobile-entry.js'),/mission-screen\.js\?v=054-23/);
