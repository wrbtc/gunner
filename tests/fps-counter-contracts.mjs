...
assert.match(html,/mobile-entry\.js\?v=desktop-054-85/);
...
assert.match(read('src/mission-screen.js'),/export const REPORT_BUILD='0\.54\.85'/);
...
assert.match(read('mobile-entry.js'),/mission-screen\.js\?v=054-85/);
