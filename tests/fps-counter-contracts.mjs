...
assert.match(html,/styles\.css\?v=054-51/);
assert.match(html,/mobile-entry\.js\?v=desktop-054-51/);
assert.match(html,/data-game-entry="\.\/main\.js\?v=054-51"/);
...
assert.match(read('src/mission-screen.js'),/export const REPORT_BUILD='0\.54\.51'/);
...
assert.match(read('mobile-entry.js'),/mission-screen\.js\?v=054-51/);
assert.match(main,/if\(!preferences\.reduced\)updateFps\(now\)/);
assert.match(main,/preferences\.reduced&&frameMetrics\.presented/);
