...
assert.match(html,/styles\.css\?v=054-31/);
assert.match(html,/mobile-entry\.js\?v=desktop-054-28/);
assert.match(html,/data-game-entry="\.\/main\.js\?v=054-28"/);
...
assert.match(read('src/mission-screen.js'),/REPORT_BUILD='0\.54\.28'/);
assert.match(read('src/mission-screen.js'),/https:\/\/gunner\.satoshis\.watch/);
assert.match(read('mobile-entry.js'),/mission-screen\.js\?v=054-28/);
