...
assert.match(html,/styles\.css\?v=054-69/);
assert.match(html,/mobile-entry\.js\?v=desktop-054-69/);
assert.match(html,/data-game-entry="\.\/main\.js\?v=054-69"/);
...
assert.match(read('src/mission-screen.js'),/export const REPORT_BUILD='0\.54\.69'/);
...
assert.match(read('mobile-entry.js'),/mission-screen\.js\?v=054-69/);
