...
assert.match(index,/styles\.css\?v=054-36/);
assert.match(index,/<script src="\.\/src\/app-viewport\.js\?v=054-36"><\/script>/);
...
assert.match(briefing,/export const REPORT_BUILD='0\.54\.36'/);
