...
assert.match(styles,/Tall\/typical laptops end-pack/);
...
assert.doesNotMatch(styles,/#intro\.mission-poster \.deployment-action\{[^}]*order:0/);
assert.doesNotMatch(styles,/#intro\.mission-poster \.poster-soon\{[^}]*order:1/);
