...
assert.match(index,/styles\.css\?v=054-49/);
assert.match(index,/<script src="\.\/src\/app-viewport\.js\?v=054-49"><\/script>/);
...
assert.match(briefing,/export const REPORT_BUILD='0\.54\.49'/);
