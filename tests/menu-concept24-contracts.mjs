...
assert.match(index,/styles\.css\?v=054-44/);
assert.match(index,/<script src="\.\/src\/app-viewport\.js\?v=054-44"><\/script>/);
...
assert.match(styles,/Drop tall order:0\/1 so natural order wins/);
...
assert.match(styles,/html\[data-app-short\] #intro\.mission-poster \.deployment-action\{[^}]*order:0/);
assert.match(styles,/html\[data-app-short\] #intro\.mission-poster \.poster-soon\{[^}]*order:1/);
...
assert.match(styles,/html\[data-app-short\] #intro\.mission-poster \.poster-body\{align-items:start/);
assert.match(styles,/html\[data-app-short\] #intro\.mission-poster \.mission-footer\{margin-top:8px/);
...
assert.match(briefing,/export const REPORT_BUILD='0\.54\.44'/);
