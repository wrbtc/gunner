...
assert.match(index,/id="reportFailedLoad"[^>]*class="quietButton"/);
...
assert.ok(index.indexOf('id="startButton"')<index.indexOf('id="nextChapter"'));
assert.ok(index.indexOf('id="startButton"')<index.indexOf('id="loadingFailureDetails"'));
...
assert.ok(index.indexOf('class="qa-diagnostics"')<index.indexOf('id="reportFailedLoad"'));
assert.ok(index.indexOf('id="reportFailedLoad"')>index.indexOf('id="nextChapter"'),'idle Report must leave the primary CTA band');
