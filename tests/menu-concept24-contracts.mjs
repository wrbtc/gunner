...
assert.match(index,/styles\.css\?v=054-30/);
assert.match(index,/<script src="\.\/src\/app-viewport\.js\?v=054-30"><\/script>/);
...
assert.ok(index.indexOf('id="reportFailedLoad"')<index.indexOf('id="nextChapter"'));
...
assert.match(styles,/@media\(max-height:920px\)[\s\S]*#intro\.mission-poster \.poster-soon\{display:none\}/);
assert.match(styles,/html\[data-app-short\] #intro\.mission-poster \.poster-soon\{display:none\}/);
