...
assert.match(world,/const lavaAccentMaterial=/);
assert.equal((world.match(/(?:lipMat|fallMat|splashMat)=lavaAccentMaterial/g)||[]).length,3);
assert.doesNotMatch(world,/(?:lipMat|fallMat|splashMat)=new THREE\.ShaderMaterial/);
