...
import {creeperLocoVisualBounds} from '../game/src/creeper-loco.js?v=054-70';
...
assert.match(main, /creeper-loco\.js\?v=054-70/);
assert.match(main, /bank-demons\.js\?v=054-70/);
assert.match(main, /optionalCreeperLoco/);
assert.match(main, /locoKit:creeperLocoBootstrap\?\.value/);
assert.match(main, /version:'0\.54\.70'/);
