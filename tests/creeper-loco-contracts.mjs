...
import {creeperLocoVisualBounds} from '../game/src/creeper-loco.js?v=054-62';
...
assert.match(main, /creeper-loco\.js\?v=054-62/);
assert.match(main, /bank-demons\.js\?v=054-62/);
