...
assert.equal(packageJson.version,'0.54.77');
assert.equal(manifest.version,'0.54.77');
...
console.log(JSON.stringify({passed:true,identity:'0.54.77',binaryStatus},null,2));
