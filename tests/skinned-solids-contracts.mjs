...
assert.equal(packageJson.version,'0.54.74');
assert.equal(manifest.version,'0.54.74');
...
console.log(JSON.stringify({passed:true,identity:'0.54.74',binaryStatus},null,2));
