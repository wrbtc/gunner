...
assert.equal(packageJson.version,'0.54.76');
assert.equal(manifest.version,'0.54.76');
...
console.log(JSON.stringify({passed:true,identity:'0.54.76',binaryStatus},null,2));
