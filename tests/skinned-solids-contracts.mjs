...
assert.equal(packageJson.version,'0.54.75');
assert.equal(manifest.version,'0.54.75');
...
console.log(JSON.stringify({passed:true,identity:'0.54.75',binaryStatus},null,2));
