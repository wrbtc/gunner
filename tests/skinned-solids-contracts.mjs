...
assert.equal(packageJson.version,'0.54.82');
assert.equal(manifest.version,'0.54.82');
...
console.log(JSON.stringify({passed:true,identity:'0.54.82',binaryStatus},null,2));
