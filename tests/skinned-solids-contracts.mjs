...
assert.equal(packageJson.version,'0.54.78');
assert.equal(manifest.version,'0.54.78');
...
console.log(JSON.stringify({passed:true,identity:'0.54.78',binaryStatus},null,2));
