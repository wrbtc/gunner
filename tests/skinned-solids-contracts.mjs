...
assert.equal(packageJson.version,'0.54.71');
assert.equal(manifest.version,'0.54.71');
...
console.log(JSON.stringify({passed:true,identity:'0.54.71',binaryStatus},null,2));
