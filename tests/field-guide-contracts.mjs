...
assert.equal(dancers[1],'Ember Priests');
assert.match(dancers[3],/Orange Ember Priests/);
assert.match(dancers[3],/ash-grey/);
...
assert.match(guide,/else if\(id==='dancers'\)\{root=solidGuideRoot\(skinnedSolids\?\.dancers\);if\(root\)styleEmberPriest\(root,1\);\}/);
...
assert.match(solids,/asset:'field-notes-v02\/ember-priest-v01'/);
...
assert.match(solids,/644687ad31207e5031baf1094fb795698c14624ad02374d2a61af2c451bcf6ea/);
...
assert.match(solids,/bytes:8339884/);
...
assert.match(solids,/e39e0226358fad716a20d9ac744c47fe8b7f00cfe958e07fc510ecbe24c97927/);
...
assert.match(guide,/styleEmberPriest\(root,1\)/);
...
assert.equal(rimmerProvenance.sourceModelSHA256,'e39e0226358fad716a20d9ac744c47fe8b7f00cfe958e07fc510ecbe24c97927');
...
assert.equal(createHash('sha256').update(dancersPortrait).digest('hex'),'d6490d4dfc74cd8c3acc741123739b1720a812c64491641fd48a0a5002a59f1f');
...
assert.equal(dancersProvenance.sourceModel,'game/assets/field-notes-v02/ember-priest-v01.glb');
assert.equal(dancersProvenance.sourceModelSHA256,'644687ad31207e5031baf1094fb795698c14624ad02374d2a61af2c451bcf6ea');
assert.equal(dancersProvenance.sourceModelBytes,8339884);
assert.match(read('.gitattributes'),/game\/assets\/field-notes-v02\/ember-priest-v01\.glb filter=lfs/);
assert.equal(dancersProvenance.imageSHA256,'d6490d4dfc74cd8c3acc741123739b1720a812c64491641fd48a0a5002a59f1f');
assert.match(dancersProvenance.render,/priest_dance/);
...
assert.match(main,/createEmberPriestKit/);

console.log(JSON.stringify({passed:true,identity:'0.54.88',imageSHA256:imageHash},null,2));
