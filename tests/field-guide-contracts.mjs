...
assert.match(solids,/asset:'cinder-maw-skinned-draft'/);
assert.match(solids,/asset:'vein-ascetic-skinned-draft'/);
assert.match(solids,/2af643fb2751ad128e6b06cf9a3244348220a4a58cb9884603e6cf9a6e13a1d4/);
assert.match(solids,/3b3dc30a3ae7dafe87b82932f37c1c371fcbce7a0db4f6491dff494e6b05bce4/);
assert.match(solids,/bytes:1004440/);
assert.match(solids,/bytes:2502928/);
...
assert.doesNotMatch(sky,/vein-ascetic-skinned-draft/);
...
assert.equal(dancersProvenance.sourceModel,'game/assets/vein-ascetic-skinned-draft.glb');
assert.equal(dancersProvenance.sourceModelSHA256,'3b3dc30a3ae7dafe87b82932f37c1c371fcbce7a0db4f6491dff494e6b05bce4');
