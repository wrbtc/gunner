...
This is the **v0.54.24 runtime with the concept-24 menu**, matching current
production. It fits the briefing to short desktop viewports, keeps its report
controls clear of the macOS Dock, and adds Bruno and Gina's Queen reveal growl and raised-arms shriek,
...
This export matches the production v0.54.24 runtime with the concept-24 menu,
