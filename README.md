...
This is the **v0.54.22 runtime with the concept-24 menu**, matching current
production. It adds Bruno and Gina's Queen reveal growl and raised-arms shriek,
timed to the cinematic, and keeps menu/outcome music silent until the player
explicitly presses `PLAY MUSIC`. It includes the full-poster chapter presentation, complete
...
This export matches the production v0.54.22 runtime with the concept-24 menu,
