...
export function createRimmers({scene,camera,game,centerAt,widthAt,bankMeshes,audio,aimTarget,progress,launch,logEvent,canAttack,activeCommitments,traceTerrain,postMaterial,captureFrame,reduced,effectsAllowed=()=>true}){
