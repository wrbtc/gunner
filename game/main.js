...
import {setGuideModelProvider,guideViewerStats,loadingStage,loadingProgress,loadingReady,loadingFailure,loadingSnapshot,boundedPreparation,yieldLoadingPaint,startupMark,createPreparationSequence} from './src/mission-screen.js?v=054-74';
...
import {createRimmers} from './src/rimmers.js?v=054-74';
...
import {createBankDemons} from './src/bank-demons.js?v=054-74';
import {loadCreeperLoco} from './src/creeper-loco.js?v=054-74';
import {loadSkinnedSolids,loadGuideDragonSolid} from './src/skinned-solids.js?v=054-74';
import {loadEggSolids} from './src/egg-solids.js?v=054-74';
import {createBlastWorld} from './src/blast-world.js?v=054-74';
import {createHellWorld} from './src/hell-world.js?v=054-77';
...
import {createMayhemFX} from './src/mayhem-fx.js?v=054-74';
...
setGuideModelProvider(async id=>{const {buildGuideModel}=await import('./src/guide-models.js?v=054-74');const skinnedSolids={...(skinnedSolidsBootstrap?.value||{})};if(id==='dragons')skinnedSolids.dragons=await loadGuideDragonSolid();return buildGuideModel(id,{eggNests,plasmaBugs,cinderModel,creeperLoco:creeperLocoBootstrap?.value,skinnedSolids});});
