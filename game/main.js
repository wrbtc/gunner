...
import {setGuideModelProvider,guideViewerStats,loadingStage,loadingProgress,loadingReady,loadingFailure,loadingSnapshot,boundedPreparation,yieldLoadingPaint,startupMark,createPreparationSequence} from './src/mission-screen.js?v=054-67';
...
import {createEggNests} from './src/egg-nests.js?v=054-67';
import {createBankDemons} from './src/bank-demons.js?v=054-67';
import {loadCreeperLoco} from './src/creeper-loco.js?v=054-67';
import {loadSkinnedSolids,loadGuideDragonSolid} from './src/skinned-solids.js?v=054-67';
import {loadEggSolids} from './src/egg-solids.js?v=054-67';
import {createBlastWorld} from './src/blast-world.js?v=054-67';
import {createHellWorld} from './src/hell-world.js?v=054-67';
import {createCinematicPass} from './src/cinematic-pass.js?v=054-67';
import {createCalderaEnvironment} from './src/caldera-light.js?v=052';
import {createMayhemFX} from './src/mayhem-fx.js?v=054-67';
...
setGuideModelProvider(async id=>{const {buildGuideModel}=await import('./src/guide-models.js?v=054-67');const skinnedSolids={...(skinnedSolidsBootstrap?.value||{})};if(id==='dragons')skinnedSolids.dragons=await loadGuideDragonSolid();return buildGuideModel(id,{eggNests,plasmaBugs,cinderModel,creeperLoco:creeperLocoBootstrap?.value,skinnedSolids});});
